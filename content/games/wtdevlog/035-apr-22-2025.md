...
<img title="BRIGHTens up your day." src="/images/games/erase-employment-game/newlight.png" alt="A rectangular light set into the ceiling... like a normal light."></img>

<span class="image-desc">One of our light models in the ceiling.</span>

<img title="Why is it on its side?" src="/images/games/erase-employment-game/backofnewlight.png" alt="The backside of our light, covered with ceiling, blocky in shape."></img>
...
<img title="I think this would scare other coders" src="/images/games/erase-employment-game/filecode.png" alt="Some code layed out visually. A first 'column' sets the number of pages, and a second 'column' sets the images for each page."></img>
