...
<img title="This boss is in for a MUGging!" src="/images/games/erase-employment-game/toboss.png" alt="Carrying a mug and taking it to the boss in our game."></img>
...
<img title="Home run!!!" src="/images/games/erase-employment-game/basket.png" alt="A mug in a trash bin with a basket ball hoop in our game."></img>
...
<img title="Our coffee nearly overflows!" src="/images/games/erase-employment-game/safecoffeesign.png" alt="The sign for our game's coffee counter. Just barely big enough to stop the text from hanging off the top of the sign."></img>

<span class="image-desc">Look out how that sign's text can barely stay inside the plaque holding it. _**points at sign**_</span>

<img title="These ceilings are high!" src="/images/games/erase-employment-game/cafesign.png" alt="A sign for our game's cafeteria. This sign has plenty of empty space above the actual text.">
...
<img title="Blueprint really has a way of embodying the term 'spaghetti code'." src="/images/games/erase-employment-game/plaquecode.png" alt="Blueprint's visual scripting language in action: I show off a tangle of code which is desperately trying to make a sign."></img>
